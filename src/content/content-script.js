        ...
        function offerToSaveCredentials(loginData) {
          ...
          prompt.innerHTML = `
            ...
            <div style="display: flex; gap: 10px;">
              <button class="securepass-save-yes" style="flex: 1; padding: 8px; background: linear-gradient(135deg, #667eea, #764ba2); color: white; border: none; border-radius: 4px; cursor: pointer;">Zapisz</button>
              <button class="securepass-save-no" style="flex: 1; padding: 8px; background: #f1f1f1; border: none; border-radius: 4px; cursor: pointer;">Anuluj</button>
            </div>
          `;
          
          document.body.appendChild(prompt);
          
          prompt.querySelector('.securepass-save-yes').addEventListener('click', async () => {
            try {
          ...
          prompt.querySelector('.securepass-save-no').addEventListener('click', () => {
            document.body.removeChild(prompt);
          });
